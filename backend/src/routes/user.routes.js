...
import  {registerUser,getPublicKey, verifyCode,googleLogin,failedLogin,loginUser, usernameUnique, forgotPassword, resendEmail, getProfileDetails, logoutUser,updateProfileDetails,changePassword}  from "../controller/user.controller.js";
import { upload } from "../middleware/multer.middleware.js";
import passport from "passport";
import authenticator from "../middleware/jwt.middleware.js";
const router = Router();

router.route('/public-key').get(getPublicKey);
